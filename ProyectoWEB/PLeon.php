...
<body>
		<style >
	body{
			background: url(FLeon.jpg) no-repeat center center fixed;
...
include ("con_db.php");
    ...
    $result =mysqli_query($conexion, "SELECT id_jugador, nombre, nacionalidad, edad, numero, posicion FROM datos_c where nombre_club='Leon'");
...
td {
   ...
   <h1><center> !!PLANTILLA COMPLETA DEL EQUIPO¡¡ </center> </h1>
	...
	<table widht=\"100%\"border=\1\">
		<thead style='background-color:#006400;'>
	<tr>
