...
<body>
		<style >
	body{
			background: url(FNexa.jpg) no-repeat center center fixed;
...
include ("con_db.php");
    ...
    $result =mysqli_query($conexion, "SELECT id_jugador, nombre, nacionalidad, edad, numero, posicion FROM datos_c where nombre_club='Necaxa'");
