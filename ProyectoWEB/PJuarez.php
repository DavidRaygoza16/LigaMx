...
<body>
		<style >
	body{
			background: url(FJuarez.png) no-repeat center center fixed;
...
include ("con_db.php");
    ...
    $result =mysqli_query($conexion, "SELECT id_jugador, nombre, nacionalidad, edad, numero, posicion FROM datos_c where nombre_club='Juarez'");
...
td {
   ...
   <h1><center> !!PLANTILLA COMPLETA DEL EQUIPO¡¡ </center> </h1>
	...
	<thead style='background-color:#6B8E23;'>
